 ...
 */
	BuiltinDefaultCode(void)	{
		...
		memset(m_rightStickButtonState, 0, NUM_JOYSTICK_BUTTONS * sizeof(bool));
		memset(m_leftStickButtonState, 0, NUM_JOYSTICK_BUTTONS * sizeof(bool));
	...
	void TeleopPeriodic(void) {
		...
		*/
			...
			if (m_driveMode != ARCADE_DRIVE) {
				printf("%s Drive\n", driveMode == ARCADE_DRIVE ? "Arcade" : "Tank");
